"""
vLLM local model adapter (OpenAI-compatible API).
"""
...
@ModelRegistry.register(ModelProvider.VLLM.value)
class VLLMModel(BaseModel):
    """vLLM local server adapter (OpenAI-compatible)."""
    ...
    def __init__(self, config: ModelConfig):
        ...
        # vLLM doesn't need auth by default
...
ModelRegistry.register("vllm")(VLLMModel)